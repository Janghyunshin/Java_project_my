...
// 생성자와 static 블락
	// 생성자 : 인스턴스 필드를 초기화, 정적 필드의 값도 초기화 가능 
...
class E	{
	...
	static { 	// 정적(static) 초기화 블럭 : 객체 생성 없이도 클래스 명으로 호출할때 초기화 
...
public class Static_3 {
	...
	public static void main(String[] args) {
		...
		System.out.println(E.b); 		// 객체 생성 없이 E.b 호출 될때 Static 블락이 작동됨 : Static의 값을 초기화 함.
