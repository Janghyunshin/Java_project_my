...
public class InitialValue_03 {
	public static void main(String[] args) {
		// 1. 메모리의 초깃값
		int value1;						// 기본 자료형에 초깃값을 할당하지 않을때
		...
		int [] value4 = null;			// 참조 자료형은 초깃값으로 null: 알 수 없는, 비어있는상태
		System.out.println(value4);
		
		// 2. Heap 메모리의 초기값 (강제 초기화) , Heap 에는 참조 자료형의 값이 할당.
		// 기본 자료형 배열일 경우?
			// boolean ; false, int : 0, double: 0.0 이 기본값 
		
		boolean [] array1 = new boolean [3];		// false가 기본 값으로 할당
		...
		for ( int i = 0; i < array1.length ; i++) {
			System.out.println("array1[" + i + "] 번쨰 방의 값은 : " + array1[i]);
		}
		System.out.println(" ======================= ");
		
		int [] array2 = new int [3]; // 0이 기본 값으로 할당
